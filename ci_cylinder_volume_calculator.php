...
Version: 1.0.0
Author: Cylinder Volume Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Cylinder Volume Calculator by www.calculator.io";

function display_calcio_ci_cylinder_volume_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_cylinder_volume_calculator', 'display_calcio_ci_cylinder_volume_calculator' );